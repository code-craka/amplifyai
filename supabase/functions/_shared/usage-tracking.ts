...
export async function checkUsageLimits(userId: string): Promise<UsageLimits | null> {
...
export function createUsageResponse(message: string, upgradeRequired: boolean = false) {
  return new Response(
    JSON.stringify({ 
      error: message,
