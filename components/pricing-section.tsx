...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="py-24 bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-900/50 dark:to-gray-900">
        ...
        <div className="text-center mb-16">
          ...
          <ScrollReveal direction="up" delay={0.6}>
            <div className="flex items-center justify-center space-x-4 mb-12">
              <span className={`text-sm font-medium ${!isAnnual ? 'text-blue-600 dark:text-blue-400' : 'text-muted-foreground'}`}>
                Monthly
              </span>
              <motion.button
              ...
              return (
                <StaggerItem key={plan.name}>
                  ...
                  >
                    ...
                    <Card className={`h-full ${colorClasses.border} ${colorClasses.gradient} shadow-lg hover:shadow-2xl transition-all duration-300 relative overflow-hidden`}>
                      {plan.popular && (
                      ...
                      <CardHeader className="relative pb-8">
                        ...
                        <div className="flex items-baseline space-x-2">
                          ...
                          <span className="text-muted-foreground">
                            {price === 0 ? "forever" : isAnnual ? "/month" : "/month"}
                          </span>
                        </div>
        ...
        <ScrollReveal direction="up" delay={1.0}>
          <div className="mt-20 grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">Expert support when you need it most</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">Scale without worrying about usage caps</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">Built for teams of all sizes</p>
            </motion.div>
          </div>
        </ScrollReveal>
