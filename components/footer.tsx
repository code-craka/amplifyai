...
const socialLinks = [
  ...
  { name: "LinkedIn", href: "https://linkedin.com/company/amplifyai", icon: Linkedin },
  { name: "Facebook", href: "https://facebook.com/amplifyai", icon: Facebook },
  { name: "Instagram", href: "https://instagram.com/amplifyai", icon: Instagram },
          ...
          <div className="py-16 border-b border-white/10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Get the latest AI content strategies, feature updates, and exclusive tips delivered to your inbox.
              </p>
            ...
            <div className="lg:col-span-2">
              <ScrollReveal direction="left">
                ...
                <p className="text-blue-100 text-lg leading-relaxed mb-6">
                  Transforming social media content creation with AI-powered innovation. 
                  From concept to viral content in minutes.
                </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <ScrollReveal direction="right">
              <div className="text-blue-100 text-center md:text-left">
                <p className="mb-1">
                  © 2025 AmplifyAI. All rights reserved.
                </p>
                <p className="text-sm">
                  Built with ❤️ by{" "}
                  <Link 
          ...
          <ScrollReveal direction="up" delay={0.4}>
            <div className="mt-8 pt-6 border-t border-white/5">
              <div className="text-center text-sm text-blue-200/70 space-y-2">
                <p>
                  AmplifyAI is GDPR compliant and SOC 2 certified. We take your privacy seriously.
                </p>
