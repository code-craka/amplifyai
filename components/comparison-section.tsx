...
import { Check, X, Crown, Zap, Users, Clock } from "lucide-react";
...
const alternatives = [
  {
    ...
    solution: "Get agency-quality content in minutes, not weeks, at 95% less cost"
  },
  {
    ...
    solution: "Scale infinitely without hiring, training, or managing additional staff"
  },
  {
    ...
    solution: "Professional results without the learning curve or time investment"
  }
];
            ...
            <tr className="border-b border-gray-100 dark:border-gray-700">
              ...
              <th className="text-center p-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20">
                <div className="flex flex-col items-center">
                  ...
                  <span className="font-bold text-blue-600 dark:text-blue-400">AmplifyAI</span>
                  <Badge variant="secondary" className="mt-1 text-xs">Recommended</Badge>
                </div>
              </th>
              <th className="text-center p-6 text-gray-600 dark:text-gray-400">Competitor A</th>
              <th className="text-center p-6 text-gray-600 dark:text-gray-400">Competitor B</th>
              <th className="text-center p-6 text-gray-600 dark:text-gray-400">Manual Process</th>
            </tr>
          </thead>
          <tbody>
              ...
              >
                ...
                <td className="p-4 text-center bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:from-blue-900/10 dark:to-purple-900/10">
                  {typeof row.amplifyai === 'boolean' ? (
                    ...
                    <span className="font-semibold text-blue-600 dark:text-blue-400">{row.amplifyai}</span>
                  )}
                </td>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <ScrollReveal direction="up" delay={0.4}>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how AmplifyAI stacks up against traditional content creation methods 
              and competing AI tools. The choice is clear.
            </p>
          </ScrollReveal>
        </div>

        {/* Alternative Solutions */}
        <StaggerContainer staggerDelay={0.2} className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
            ...
            return (
              <StaggerItem key={alt.name}>
                <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="mb-6">
                    <h4 className="font-medium text-red-600 dark:text-red-400 mb-3">Problems:</h4>
                  ...
                  <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                    <h4 className="font-medium text-green-700 dark:text-green-400 mb-2">AmplifyAI Solution:</h4>
                    <p className="text-sm text-green-600 dark:text-green-300">{alt.solution}</p>
                  </div>
                </div>
              </StaggerItem>
            );
        ...
        <ScrollReveal direction="up" delay={0.8}>
          <div className="mt-20 grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { metric: "95%", label: "Cost Savings", description: "vs. hiring agencies" },
              { metric: "10x", label: "Faster", description: "than manual creation" },
              { metric: "99%", label: "Accuracy", description: "in brand voice matching" },
              { metric: "24/7", label: "Availability", description: "never sleeps or takes breaks" }
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
