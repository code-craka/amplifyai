...
const features = [
  {
    ...
    description: "GPT-4 and Gemini AI models create engaging, brand-consistent content that converts.",
    color: "blue",
    badge: "AI-Powered"
  },
  {
    ...
    description: "Content automatically optimized for LinkedIn, Twitter, Facebook, and Instagram formats.",
    color: "purple",
  ...
  },
  {
    ...
    description: "AI-powered posting times for maximum engagement based on audience behavior analysis.",
    color: "green",
    badge: "Automated"
  },
  {
    ...
    description: "Real-time engagement tracking with AI-powered insights and optimization suggestions.",
    color: "orange",
    badge: "Data-Driven"
  },
  {
    ...
    description: "Maintain your unique brand voice across all content and platforms automatically.",
    color: "pink",
    badge: "Brand-Safe"
  },
  {
    ...
    description: "Review, approve, and collaborate on content with team workflows and permissions.",
    color: "indigo",
    badge: "Team-Ready"
  },
  {
    ...
    description: "Bank-grade security with GDPR compliance and enterprise data protection.",
    color: "red",
    badge: "Secure"
  },
  {
    icon: Globe,
    title: "Global Reach",
    description: "Multi-language support with cultural context for international campaigns.",
    color: "teal",
    badge: "Global"
  },
  {
    ...
    description: "Complete content workflows from brief to publish with approval processes.",
    color: "cyan",
    badge: "Automated"
  }
];
...
export function FeaturesShowcase() {
  return (
    <section id="features" className="py-24 bg-gradient-to-b from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-900/50">
        ...
        <ScrollReveal direction="up" delay={0.8}>
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground">Industry-specific content templates for every use case</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">Generate 30 posts in under 60 seconds with AI acceleration</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">Enterprise SLA with 24/7 monitoring and support</p>
            </motion.div>
          </div>
        </ScrollReveal>
      </div>
