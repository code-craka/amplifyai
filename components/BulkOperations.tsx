...
export function BulkOperations({ 
  ...
  const handleBulkSchedule = () => {
    if (bulkScheduleDate && bulkScheduleTime) {
      const scheduleDateTime = new Date(`${bulkScheduleDate}T${bulkScheduleTime}`);
  ...
  const isAllSelected = allPosts.length > 0 && selectedPosts.size === allPosts.length;
  const isPartiallySelected = selectedPosts.size > 0 && selectedPosts.size < allPosts.length;
            ...
            <Dialog open={scheduleDialogOpen} onOpenChange={setScheduleDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Schedule {selectedPosts.size} selected posts for a specific date and time.
                  </DialogDescription>
                </DialogHeader>
                ...
                <DialogFooter>
                  ...
                  <Button onClick={handleBulkSchedule} disabled={!bulkScheduleDate || !bulkScheduleTime}>
                    Schedule Posts
                  </Button>
                </DialogFooter>
              </DialogContent>
