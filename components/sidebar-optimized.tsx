...
const UserProfileSection = ({ user, isCollapsed, onSignOut }: {
  user: {
...
export function Sidebar({ children }: SidebarProps) {
  ...
  const isActiveLink = useCallback((href: string) => {
    ...
    if (href === "/dashboard") {
      return pathname === "/dashboard" || (pathname.startsWith("/dashboard") && !pathname.includes("?"));
    }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
          ...
          {/* Theme Switcher */}
          <div className={cn("flex pt-4", isCollapsed ? "justify-center" : "justify-start")}>
            <ThemeSwitcher />
          </div>
