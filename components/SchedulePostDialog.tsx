...
export function SchedulePostDialog({ 
  ...
  const handleSchedule = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMsg = error instanceof Error ? error.message : 'Failed to schedule post';
  ...
  const handleCancel = async () => {
    ...
    try {
      ...
      const errorMsg = error instanceof Error ? error.message : 'Failed to cancel scheduled post';
      toast.error(errorMsg);
    } finally {
      setIsLoading(false);
    }
