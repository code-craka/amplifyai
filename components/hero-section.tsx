...
import { TypingAnimation, CountingAnimation } from "@/components/ui/typing-animation";
...
export function HeroSection() {
  const dynamicWords = ["6 minutes", "AI-powered", "effortless", "professional"];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <ScrollReveal direction="up" delay={0.6}>
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-4xl mx-auto leading-relaxed">
            ...
            in <span className="font-semibold text-blue-600 dark:text-blue-400">minutes, not hours</span>. 
        ...
        {/* Animated Stats */}
        <StaggerContainer staggerDelay={0.15} className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
          <StaggerItem>
            <motion.div 
          ...
          <StaggerItem>
            ...
            >
              ...
              <div className="text-sm text-muted-foreground font-medium">Content Output</div>
          ...
          <StaggerItem>
            ...
            >
              <div className="text-4xl font-bold text-green-500 mb-2">
                <CountingAnimation from={0} to={500} suffix="+" duration={2.5} />
              </div>
              <div className="text-sm text-muted-foreground font-medium">Brands Trusting Us</div>
          ...
          <StaggerItem>
            ...
            >
              <div className="text-4xl font-bold text-orange-500 mb-2">
                <CountingAnimation from={0} to={24} suffix="/7" duration={2.5} />
              </div>
              <div className="text-sm text-muted-foreground font-medium">AI Availability</div>
