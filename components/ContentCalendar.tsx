...
export function ContentCalendar({ briefs }: ContentCalendarProps) {
    ...
    return (
      <div className="grid grid-cols-7 gap-0">
        {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
          <div key={day} className="h-10 border border-gray-200 dark:border-gray-700 flex items-center justify-center font-medium bg-gray-50 dark:bg-gray-800">
            {day}
          </div>
        ))}
        {days}
  ...
  const renderWeekView = () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      weekDays.push(
        <div key={i} className="flex-1 border border-gray-200 dark:border-gray-700 p-4">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-500">
                      Brief: {post.brief.topic} | Brand: {post.brief.brands?.brand_name}
                    </div>
                  </div>
