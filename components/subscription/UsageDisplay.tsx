...
import { FileText, Building2, Zap, TrendingUp } from 'lucide-react'
        ...
        <CardContent>
          <div className="flex items-center justify-between text-sm text-gray-600">
            ...
            <span className="font-medium">
              {usage.billingCycleEnd ? formatDate(usage.billingCycleEnd) : 'N/A'}
            </span>
          </div>
        </CardContent>
      </Card>
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className={getUsageColor(postsPercentage)}>
                {isUnlimited(postsTotal) ? '∞' : `${usage.postsGenerated}/${postsTotal}`}
              </Badge>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className={getUsageColor(brandsPercentage)}>
                {isUnlimited(brandsTotal) ? '∞' : `${usage.brandsCreated}/${brandsTotal}`}
              </Badge>
            </div>
          </CardHeader>
          <CardContent>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center">
              ...
              <p className="text-sm text-yellow-800">
                You&apos;re approaching your monthly post limit. Consider upgrading your plan.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-yellow-200 bg-yellow-50">
          <CardContent className="pt-6">
            <div className="flex items-center">
              <div className="w-2 h-2 bg-yellow-600 rounded-full mr-3"></div>
              <p className="text-sm text-yellow-800">
                You&apos;re approaching your brand limit. Consider upgrading your plan.
              </p>
            </div>
          </CardContent>
        </Card>
