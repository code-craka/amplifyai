...
import { Loader2, CreditCard, BarChart3, Receipt, Settings, ExternalLink } from 'lucide-react'
  ...
  const loadSubscriptionData = useCallback(async () => {
    try {
      ...
      if (usageData && usageData.length > 0) {
        ...
        const planType = (subData?.plan_type || 'free') as keyof typeof SUBSCRIPTION_PLANS
