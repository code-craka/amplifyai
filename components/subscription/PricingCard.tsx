...
import { Check, Loader2, Zap, Users, Crown } from 'lucide-react'
...
export function PricingCard({ plan, currentPlan, onUpgrade, isLoading }: PricingCardProps) {
  ...
  return (
    <Card className={`relative ${plan === 'pro' ? 'border-2 border-blue-500 shadow-lg' : ''}`}>
      {plan === 'pro' && (
      ...
      <CardHeader className="text-center">
        <div className={`w-12 h-12 mx-auto rounded-full flex items-center justify-center mb-4 ${planColors[plan]}`}>
          ...
          <div className="space-y-2 text-sm text-gray-600">
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                {planConfig.limits.monthlyPosts === -1 ? 'Unlimited' : planConfig.limits.monthlyPosts}
              </span>
            </div>
            <div className="flex justify-between">
              <span>Brands:</span>
              <span className="font-medium">
                {planConfig.limits.brands === -1 ? 'Unlimited' : planConfig.limits.brands}
              </span>
            </div>
            <div className="flex justify-between">
