...
import { stripe, STRIPE_WEBHOOK_SECRET, SUBSCRIPTION_PLANS } from '@/lib/stripe/config'
      ...
      case 'invoice.payment_succeeded': {
        ...
        await supabase
          ...
          .insert({
            ...
            status: 'paid',
            stripe_payment_intent_id: 'payment_intent' in invoice ? (invoice.payment_intent as string) : null,
            stripe_invoice_id: invoice.id,
            plan_type: userSub.plan_type,
            billing_period_start: new Date((invoice.period_start as number) * 1000).toISOString(),
            billing_period_end: new Date((invoice.period_end as number) * 1000).toISOString(),
