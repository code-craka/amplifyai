      ...
      .on(
        ...
        (payload) => {
          ...
          if (payload.new.status === 'completed') {
            toast.success('🎉 Campaign completed! Your content is ready for review.')
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {selectedBrand && (
              <div className="p-3 bg-muted rounded-md text-sm">
                <p><strong>Description:</strong> {selectedBrand.brand_description}</p>
                <p><strong>Tone:</strong> {selectedBrand.tone_of_voice}</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full p-2 border rounded-md"
            >
              <option value="Generate buzz and engagement">Generate buzz and engagement</option>
              ...
              <option value="Promote product launch">Promote product launch</option>
