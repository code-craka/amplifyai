...
export function BrandsManager({ initialBrands }: BrandsManagerProps) {
  ...
  const handleAddBrand = useCallback(async (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
  ...
  const handleUpdateBrand = useCallback(async (e: React.FormEvent) => {
    e.preventDefault();
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Create and manage your brand identities for content generation</p>
        </div>
        <Button 
