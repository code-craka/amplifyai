      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <Card className="mb-8 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 border-green-200 dark:border-green-800">
            ...
            <CardContent>
              <p className="mb-4 text-muted-foreground">
                If you believe you&apos;re eligible for a refund based on our policy below, 
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  <p>
                    AmplifyAI is committed to customer satisfaction. While our services are generally 
                    non-refundable due to their digital nature and immediate delivery, we offer refunds 
                    in specific circumstances outlined in this policy.
                  </p>
                  <p>
                    All refund requests must be submitted within the applicable time frame and meet 
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    First-time subscribers to our Pro or Agency plans are eligible for a full refund 
                    if requested within 14 days of the initial subscription.
                  </p>

                  <h4>2.2 Eligibility Requirements</h4>
                  <ul>
                    <li>Must be a first-time subscriber (not previously refunded)</li>
                    <li>Request must be made within 14 calendar days</li>
                    <li>Account must not have violated our Terms of Service</li>
                    <li>Usage must be within reasonable limits (not excessive)</li>
                  </ul>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    If our service experiences significant downtime (more than 24 consecutive hours), 
                    affected customers may be eligible for a prorated refund or service credit.
                  </p>

                  <h4>3.2 Major Feature Failures</h4>
                  <p>
                    If core features fail to work as advertised for an extended period, we may offer 
                    partial refunds or service credits at our discretion.
                  </p>

                  <h4>3.3 Billing Errors</h4>
                  <p>
                    We will promptly refund any charges resulting from billing errors, including:
                  </p>
                  <ul>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <ul>
                    <li>Automatic renewal charges (after the initial period)</li>
              ...
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <ul>
                    ...
                    <li><strong>Review Period:</strong> Up to 5 business days</li>
                    <li><strong>Decision Notification:</strong> Via email</li>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    In certain circumstances, we may offer prorated refunds based on unused service time:
                  </p>
                  <ul>
                  ...
                  <p>
                    We may offer service credits instead of refunds for:
                  </p>
                  <ul>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    Cancelling your subscription stops future billing but does not trigger an automatic refund. 
                    You can continue using the service until the end of your current billing period.
                  </p>

                  <h4>7.2 Immediate Termination</h4>
                  <p>
                    If you need to terminate service immediately and qualify for a refund, 
                    please contact our billing team to discuss your options.
                  </p>

                  <h4>7.3 Data Retention</h4>
                  <p>
                    After cancellation or refund, your data will be retained according to our 
                    data retention policy, typically 30 days for account recovery purposes.
                  </p>
                </CardContent>
              </Card>
            </section>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    If your refund request is denied, you may appeal the decision by providing 
                    additional information or documentation to billing@amplifyai.com.
                  </p>

                  <h4>8.2 Chargeback Prevention</h4>
                  <p>
                    Before initiating a chargeback with your bank or credit card company, 
                    please contact us to resolve the issue. Chargebacks may result in account suspension.
                  </p>
        ...
        <ScrollReveal direction="up" delay={1.1}>
          <Card className="mt-12 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-green-200 dark:border-green-800">
            ...
            <CardContent>
              <p className="mb-4">
                Our billing team is here to help with refund requests and billing questions:
              </p>
              <div className="space-y-2 text-sm">
                <p><strong>Email:</strong> billing@amplifyai.com</p>
                <p><strong>Response Time:</strong> 2 business days</p>
                <p><strong>Business Hours:</strong> Monday-Friday, 9 AM - 6 PM PST</p>
                <p><strong>Emergency Billing:</strong> security@amplifyai.com</p>
              </div>
              <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <p className="text-sm">
                  <strong>Tip:</strong> Include your account email, billing details, and reason for refund 
