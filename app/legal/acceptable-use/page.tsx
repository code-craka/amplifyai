...
import { AlertTriangle, Calendar, Shield, Ban, CheckCircle } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-green-700 dark:text-green-300 text-sm">
                      Creating legitimate business content, following platform guidelines, 
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-red-700 dark:text-red-300 text-sm">
                      Illegal activities, harmful content, spam, harassment, 
                      or violating platform terms.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  <p>
                    This Acceptable Use Policy (&quot;AUP&quot;) governs your use of AmplifyAI&apos;s services and 
                    defines what constitutes acceptable and unacceptable behavior on our platform.
                  </p>
                  <p>
                    By using AmplifyAI, you agree to comply with this policy and all applicable laws 
                    and regulations. Violations may result in account suspension or termination.
                  </p>
                </CardContent>
              </Card>
            </section>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>You must not use AmplifyAI for any illegal purposes, including:</p>
                  <ul>
                  ...
                  <ul>
                    ...
                    <li>Includes explicit sexual content or child exploitation</li>
              ...
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <ul>
                    ...
                    <li>Respect character limits and formatting requirements</li>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    We may monitor content and activities to ensure compliance with this policy. 
                    However, we do not pre-screen all content and are not responsible for user-generated content.
                  </p>
                  ...
                  <p>
                    If you believe enforcement action was taken in error, you may appeal by 
                    contacting our support team with relevant details and evidence.
                  </p>
                </CardContent>
              </Card>
            </section>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <ul>
                    <li><strong>Email:</strong> abuse@amplifyai.com</li>
                    <li><strong>In-app reporting:</strong> Use the report feature in our platform</li>
                    <li><strong>Emergency issues:</strong> security@amplifyai.com</li>
                  </ul>
                  <p>
                    Please provide as much detail as possible, including screenshots, 
                    URLs, and a description of the violation.
                  </p>
                </CardContent>
              </Card>
            </section>
        ...
        <ScrollReveal direction="up" delay={0.9}>
          <Card className="mt-12 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border-orange-200 dark:border-orange-800">
            ...
            <CardContent>
              <p className="mb-4">
                If you have questions about this Acceptable Use Policy or need clarification 
                about specific use cases, please contact us:
              </p>
              <div className="space-y-2 text-sm">
                <p><strong>General Questions:</strong> support@amplifyai.com</p>
                <p><strong>Policy Violations:</strong> abuse@amplifyai.com</p>
                <p><strong>Legal Inquiries:</strong> legal@amplifyai.com</p>
              </div>
            </CardContent>
          </Card>
        </ScrollReveal>
