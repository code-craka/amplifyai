...
import { Shield, Calendar, Download, Trash2, Edit, Eye, Lock, AlertCircle } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Card className="text-center border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">View your personal data</p>
              </CardContent>
            </Card>
          ...
          <Card className="mb-8 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border-blue-200 dark:border-blue-800">
            ...
            <CardContent>
              <p className="mb-6 text-muted-foreground">
                As an EU resident, you have specific rights regarding your personal data. Use the actions below 
                to exercise these rights or contact our Data Protection Officer for assistance.
              </p>
              ...
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  <p>
                    ...
                    that came into effect on May 25, 2018. It gives EU residents greater control over 
                    their personal data and imposes strict requirements on organizations that process such data.
                  </p>
                  <p>
                    At AmplifyAI, we are committed to full GDPR compliance and respect your privacy rights. 
                    This page explains how we implement GDPR requirements and how you can exercise your rights.
                  </p>
                </CardContent>
              </Card>
            </section>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    You have the right to know what personal data we hold about you, how we use it, 
                    and who we share it with. You can request a copy of your personal data at any time.
                  </p>
                  <p><strong>How to exercise:</strong> Visit your account settings or contact our DPO.</p>

                  <h4>2. Right to Rectification (Article 16)</h4>
                  <p>
                    You can request correction of inaccurate or incomplete personal data. We will update 
                    your information promptly upon verification.
                  </p>
                  <p><strong>How to exercise:</strong> Update your profile in account settings or contact support.</p>
                  ...
                  <p><strong>How to exercise:</strong> Delete your account or contact our DPO with specific deletion requests.</p>
                  ...
                  <p><strong>How to exercise:</strong> Use our data export feature in account settings.</p>

                  <h4>6. Right to Object (Article 21)</h4>
                  <p>
                    You can object to certain types of processing, particularly for direct marketing purposes 
                    or processing based on legitimate interests.
                  </p>

                  <h4>7. Rights Related to Automated Decision-Making (Article 22)</h4>
                  <p>
                    You have rights regarding automated decision-making and profiling. We will inform you 
                    about any automated processing that significantly affects you.
                  </p>
                </CardContent>
              </Card>
            </section>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <ul>
                    <li><strong>Identity Data:</strong> Name, email address, account credentials</li>
                    <li><strong>Contact Data:</strong> Email address, company information</li>
                    <li><strong>Technical Data:</strong> IP address, browser type, device information</li>
                    <li><strong>Usage Data:</strong> Platform interaction, feature usage, preferences</li>
                    <li><strong>Content Data:</strong> Brand information, content briefs, generated posts</li>
                    <li><strong>Marketing Data:</strong> Communication preferences, engagement data</li>
                  </ul>

                  <h4>Data Processors We Use</h4>
                  <p>We work with trusted data processors who meet GDPR standards:</p>
                  <ul>
                    ...
                    <li><strong>OpenAI:</strong> AI content generation (US)</li>
                    <li><strong>Google Cloud:</strong> AI services and infrastructure (EU/US)</li>
                    <li><strong>Vercel:</strong> Web hosting and CDN (EU/US)</li>
                  </ul>
              ...
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <ul>
                    ...
                    <li><strong>Regular Updates:</strong> Security patches and vulnerability management</li>
                  </ul>

                  <h4>Organizational Measures</h4>
                  <ul>
                    <li><strong>Privacy by Design:</strong> Data protection built into our systems</li>
                    <li><strong>Staff Training:</strong> Regular GDPR and security training for all employees</li>
                  ...
                  <p>
                    In case of a data breach, we will notify relevant supervisory authorities within 72 hours 
                    and affected individuals without undue delay, as required by GDPR.
                  </p>
                </CardContent>
              </Card>
            </section>
                    ...
                    <table className="w-full border-collapse border border-gray-300 dark:border-gray-700">
                      <thead>
                        <tr className="bg-gray-50 dark:bg-gray-800">
                          ...
                          <th className="border border-gray-300 dark:border-gray-700 p-3 text-left">Legal Basis</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Account Data</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Until account deletion + 30 days</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Contract performance</td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Content Data</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Until deletion by user</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Contract performance</td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Usage Analytics</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">2 years (anonymized after 6 months)</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Legitimate interests</td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Support Records</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">5 years</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Legitimate interests</td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Financial Records</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">7 years</td>
                          <td className="border border-gray-300 dark:border-gray-700 p-3">Legal obligation</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
            ...
            <section>
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>Many rights can be exercised directly through your account:</p>
                  <ul>
                    <li><strong>Account Settings:</strong> Update personal information and preferences</li>
                    <li><strong>Privacy Dashboard:</strong> View and manage your data</li>
                  ...
                  <ul>
                    <li><strong>Email:</strong> gdpr@amplifyai.com</li>
                    <li><strong>Response Time:</strong> 30 days maximum (usually within 5 business days)</li>
                  ...
                  <p>
                    ...
                    with your local data protection authority. In the EU, you can find your authority at:{" "}
                    <a href="https://edpb.europa.eu/about-edpb/board/members_en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <p><strong>Email:</strong> gdpr@amplifyai.com</p>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <p><strong>Email:</strong> eu-representative@amplifyai.com</p>
                    <p><strong>Address:</strong> GDPR Representative Services</p>
                    <p><strong>City:</strong> Dublin, Ireland</p>
                  </div>
                </div>
              </div>
              <div className="mt-6 p-4 bg-blue-100 dark:bg-blue-900/20 rounded-lg">
                <p className="text-sm">
                  <strong>Emergency Data Protection Concerns:</strong> For urgent security or privacy matters, 
                  contact security@amplifyai.com or call our 24/7 security hotline.
                </p>
              </div>
            </CardContent>
          </Card>
