              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-orange-700 dark:text-orange-300">
                    By accessing or using AmplifyAI, you agree to be bound by these Terms of Service. 
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
                <Link href="#acceptance" className="text-blue-600 hover:underline">1. Acceptance of Terms</Link>
                <Link href="#description" className="text-blue-600 hover:underline">2. Service Description</Link>
                <Link href="#accounts" className="text-blue-600 hover:underline">3. User Accounts</Link>
                <Link href="#acceptable-use" className="text-blue-600 hover:underline">4. Acceptable Use</Link>
                <Link href="#subscription" className="text-blue-600 hover:underline">5. Subscription & Billing</Link>
                <Link href="#intellectual-property" className="text-blue-600 hover:underline">6. Intellectual Property</Link>
                <Link href="#privacy" className="text-blue-600 hover:underline">7. Privacy & Data</Link>
                <Link href="#termination" className="text-blue-600 hover:underline">8. Termination</Link>
                <Link href="#disclaimers" className="text-blue-600 hover:underline">9. Disclaimers</Link>
              </div>
            </CardContent>
          </Card>
        </ScrollReveal>
              ...
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  <p>
                    ...
                    (&quot;User&quot;, &quot;you&quot;, or &quot;your&quot;) and AmplifyAI (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) 
                    regarding your use of the AmplifyAI platform and services.
                  </p>
                  <p>
                    By creating an account, accessing, or using our service, you acknowledge that you have read, 
                    understood, and agree to be bound by these Terms, our Privacy Policy, and any additional 
          ...
          <ScrollReveal direction="up" delay={0.5}>
            <section id="description">
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  <p>
                    AmplifyAI is an AI-powered social media content generation platform that provides:
                  </p>
                  <ul>
            ...
            <section id="accounts">
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    You must be at least 18 years old to use our service. By using AmplifyAI, 
            ...
            <section id="acceptable-use">
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    You may use AmplifyAI for lawful business and personal purposes in accordance with these Terms.
                  </p>
            ...
            <section id="subscription">
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    AmplifyAI offers various subscription plans with different features and usage limits. 
                  ...
                  <p>
                    Each subscription plan includes specific usage limits. Exceeding these limits may 
                    result in service restrictions or additional charges.
                  </p>
            ...
            <section id="intellectual-property">
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    AmplifyAI and all related technology, content, and materials are owned by us 
                  ...
                  <p>
                    ...
                    you grant us a limited license to process, store, and display your content 
                    as necessary to provide our services.
                  </p>

                  <h4>6.3 Generated Content</h4>
                  <p>
                    Content generated by our AI belongs to you, subject to our terms and any 
                    applicable third-party terms. You are responsible for ensuring generated 
            ...
            <section id="privacy">
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    We comply with applicable data protection laws, including GDPR. For more information 
                    about your data rights, please see our{" "}
                    <Link href="/legal/gdpr" className="text-blue-600 hover:underline">
                      GDPR Compliance
                    </Link> page.
                  </p>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    ...
                    or engage in activities that harm our service or other users.
                  </p>
              ...
              <Card>
                ...
                <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <p>
                    ...
                    that our service will be uninterrupted, error-free, or meet your specific requirements.
                  </p>
          ...
          <Card className="mt-12 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border-blue-200 dark:border-blue-800">
            ...
            <CardContent>
              ...
              <div className="space-y-2 text-sm">
                <p><strong>Email:</strong> legal@amplifyai.com</p>
                <p><strong>Address:</strong> AmplifyAI Legal Department</p>
                <p><strong>Effective Date:</strong> December 28, 2024</p>
              </div>
            </CardContent>
          </Card>
        </ScrollReveal>
