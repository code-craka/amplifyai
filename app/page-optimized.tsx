...
export const metadata: Metadata = {
  ...
  description: "Transform your social media strategy with AI. Create professional content campaigns in minutes, not hours. Trusted by 1200+ brands worldwide. Free trial available.",
  keywords: ["AI content creation", "social media marketing", "content automation", "social media tools", "AI copywriting"],
  openGraph: {
    title: "AmplifyAI - AI-Powered Social Media Content Creation",
    description: "Create professional social media content in minutes with AI. Save 95% time on content creation.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-20">
        <ScrollReveal direction="up">
          <Badge variant="secondary" className="mb-6 px-4 py-2 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300">
        ...
        <ScrollReveal direction="up" delay={0.4}>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            No design skills, no copywriting experience, no marketing degree required. 
            Just describe your vision and let our AI do the heavy lifting.
          </p>
        </ScrollReveal>
      </div>
        ...
        {[
          {
            ...
            description: "Tell us your brand story, target audience, and campaign goals. Our AI understands context, tone, and industry-specific requirements.",
            details: ["Brand voice analysis", "Audience targeting", "Goal optimization", "Tone customization"],
            color: "blue",
            delay: 0.6
          },
          {
            ...
            description: "Advanced AI models generate platform-optimized content with captions, hashtags, and visual suggestions in seconds.",
            details: ["Multi-platform optimization", "SEO-friendly hashtags", "Visual suggestions", "A/B test variants"],
            color: "purple",
            delay: 0.8
          },
          {
            ...
            description: "Review, schedule, and track performance. Get AI-powered insights to continuously improve your content strategy.",
            details: ["Smart scheduling", "Performance tracking", "Optimization tips", "ROI analytics"],
            color: "green",
            delay: 1.0
          }
        ].map((item) => (
            ...
            <div className="relative group">
              <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 group-hover:border-blue-200 dark:group-hover:border-blue-700">
                <div className="relative mb-8">
                  <div className={`w-16 h-16 bg-gradient-to-r from-${item.color}-500 to-${item.color}-600 text-white rounded-2xl flex items-center justify-center text-xl font-bold shadow-lg group-hover:shadow-${item.color}-500/25 transition-all duration-300 group-hover:scale-110`}>
                    {item.step}
                  </div>
                ...
                <h3 className={`text-2xl font-semibold mb-4 group-hover:text-${item.color}-600 transition-colors`}>
                  {item.title}
                </h3>
                ...
                <ul className="space-y-2">
                  {item.details.map((detail, index) => (
                    <li key={index} className="flex items-center text-sm text-muted-foreground">
                      <div className={`w-1.5 h-1.5 bg-${item.color}-500 rounded-full mr-3 flex-shrink-0`} />
                      {detail}
                    </li>
                  ))}
                </ul>
      ...
      <ScrollReveal direction="up" delay={1.2}>
        <div className="text-center mt-16">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 max-w-md mx-auto">
            ...
            <p className="text-muted-foreground mb-6">Join 1200+ businesses already creating better content with AI</p>
            <AnimatedButton 
              variant="gradient" 
              size="lg" 
              animation="glow"
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <ScrollReveal direction="up">
        <div className="text-center mb-12">
          ...
          <h3 className="text-2xl font-semibold mb-2">Join the AI content revolution</h3>
          <p className="text-muted-foreground">Backed by real results from real businesses</p>
        </div>
      </ScrollReveal>
    ...
    <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <ScrollReveal direction="up" delay={0.4}>
        <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
          Join before the end of this month and save big. Over 200 businesses signed up this week alone.
        </p>
      </ScrollReveal>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <ScrollReveal direction="up" delay={0.4}>
            <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
              Join the AI content revolution today. Create professional campaigns in minutes, 
              save 95% of your time, and watch your engagement soar.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal direction="up" delay={0.8}>
            <div className="mt-12 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-white">⚡</div>
                <div className="text-sm text-blue-100 mt-2">Setup in 60 seconds</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">🔒</div>
