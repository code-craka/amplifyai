...
import { Linkedin, Twitter, Instagram, Facebook, Trash2 } from 'lucide-react'
...
export function SocialConnectionsManager({ initialConnections }: SocialConnectionsManagerProps) {
              ...
              <div key={platform} className="p-4 border rounded-lg flex items-center justify-between">
                ...
                {connection ? (
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-gray-500">{connection.platform_user_name}</span>
