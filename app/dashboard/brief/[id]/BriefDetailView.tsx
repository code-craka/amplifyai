  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {brief.brands.brand_name} • {new Date(brief.created_at).toLocaleDateString()}
          </p>
        </div>
        ...
        <CardContent className="space-y-4">
          ...
          {brief.cta_text && (
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">{brief.cta_text}</p>
            </div>
          )}
          <div>
            <h4 className="font-medium mb-1">Brand Guidelines</h4>
            <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
              <p><strong>Description:</strong> {brief.brands.brand_description}</p>
              <p><strong>Tone:</strong> {brief.brands.tone_of_voice}</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold">Generated Posts ({brief.generated_posts.length})</h2>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-2">
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => handleCopyToClipboard(post.generated_text)}
                      >
      ...
      {schedulingPost && (
        <SchedulePostDialog
          ...
          platform={brief.generated_posts.find(p => p.id === schedulingPost)?.platform || ''}
          currentScheduleTime={brief.generated_posts.find(p => p.id === schedulingPost)?.schedule_time}
